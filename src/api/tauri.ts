...
import type { AppState, DeepseekLauncher, DeepseekStatus, ProviderDescriptor, SessionRecord, SessionSource } from "../types";

export function listProviders(): Promise<ProviderDescriptor[]> {
  return invoke<ProviderDescriptor[]>("list_providers");
}

export function listSessions(params: { source?: SessionSource; sessionsDir?: string | null }): Promise<SessionRecord[]> {

...
const zh = {
  ...
  usage_data_note: "统计基于独立用量索引，daily usage 按 session/thread 创建时间的本地日期归属。",
  rel_just_now: "刚刚",
  rel_minutes: "{n} 分钟前",
  rel_hours: "{n} 小时前",
  rel_days: "{n} 天前"
...
const en: Dict = {
  ...
  usage_data_note: "Usage is based on the independent usage index. Daily usage is attributed to each session/thread creation date in local time.",
